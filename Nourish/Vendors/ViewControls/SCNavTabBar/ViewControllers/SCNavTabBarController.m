...
- (void)viewInit {
    ...
    _mainView = [[UIScrollView alloc] initWithFrame:CGRectMake(DOT_COORDINATE, _navTabBar.frame.origin.y + _navTabBar.frame.size.height, SCREEN_WIDTH, SCREEN_HEIGHT - NAV_TAB_BAR_HEIGHT - STATUS_BAR_HEIGHT - NAVIGATION_BAR_HEIGHT)];
    ...
    _mainView.contentSize = CGSizeMake(SCREEN_WIDTH *_subViewControllers.count, SCREEN_HEIGHT-NAV_BAR_HEIGHT-NAV_TAB_BAR_HEIGHT);
...
- (void)addParentController:(UIViewController *)viewController {
    ...
    viewController.view.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-NAV_BAR_HEIGHT);
    [viewController.view addSubview:self.view];
    self.view.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-NAV_BAR_HEIGHT);
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    self.currentSubController = [self.subViewControllers objectAtIndex:_navTabBar.currentItemIndex];
     if ([self.currentSubController respondsToSelector:@selector(viewDidCurrentView)]) {
         [self.currentSubController viewDidCurrentView];
     }
}
