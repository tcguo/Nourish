...
- (id)initWithTitle:(NSString *)title delegate:(id<LXActionSheetDelegate>)delegate cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitlesArray;
{
    ...
    if (self) {
        ...
        self.btnWidth = BUTTON_WIDTH *self.appdelegate.autoSizeScaleX;
        self.btnHeight = BUTTON_HEIGHT *self.appdelegate.autoSizeScaleY;
...
{
    UIButton *destructiveButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, self.btnWidth, self.btnHeight)];
    ...
    [destructiveButton setImage:[UIImage imageNamed:@"dinner-wu"] forState:UIControlStateNormal];
    return destructiveButton;
}

- (UIButton *)creatOtherButtonWith:(NSString *)otherButtonTitle withPostion:(NSInteger )postionIndex {
    UIButton *otherButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT + (postionIndex*(self.btnHeight+(BUTTON_INTERVAL_HEIGHT/2))), self.btnWidth, self.btnHeight)];
...
{
    UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, self.btnWidth, self.btnHeight)];
...
//        }
//    }
//    else if (self.isHadCancelButton == YES) {
//        if (self.delegate) {
